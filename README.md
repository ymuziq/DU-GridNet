# DU-GridNet for Raman Baseline Correction

Code and example data for **DU-GridNet**, developed for baseline correction of Raman spectra.
...
**"Baseline Correction Using DU-GridNet for Raman Spectra."**
